...
interface IJBDistributor {
     ...
     *
     */
    function tokenAtRound(IERC20 _token, uint256 _round)
        external
        view
        returns (uint256 _balance, uint256 _vestingAmount);
     ...
     */
    function tokenVesting(uint256 _721TokenID, uint256 _round, IERC20 _token)
        external
        view
        returns (uint256 _tokenVestingAmount);
     ...
     */
    function collectVestedRewards(uint256[] calldata _tokenIds, IERC20[] calldata _tokens, uint256 _round) external;
